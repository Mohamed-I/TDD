...
from TDD.netflix_movies import get_earliest_published_date
from TDD.netflix_movies import get_highest_revenue
from TDD.netflix_movies import get_title_and_highest_or_lowest_revenue
from TDD.netflix_movies import get_title_and_highest_or_lowest_revenue_and_release_data


def test_get_lowest_revenue(data_fixture: Any) -> None:
    """Test get_highest_revenue function."""
    result = get_highest_revenue(data_fixture, flag=True)
    assert result == 2923706026


def test_get_highest_revenue(data_fixture: Any) -> None:
    """Test get_highest_revenue function."""
    result = get_highest_revenue(data_fixture, flag=False)
    assert result == 0


def test_get_latest_published_date(data_fixture: Any) -> None:
...
def test_get_earliest_published_date(data_fixture: Any) -> None:
    """Test get_earliest_published_date function."""
    result = get_earliest_published_date(data_fixture, flag=False)
    assert result == "1931-02-01"


def test_get_title_and_lowest_revenue(data_fixture: Any) -> None:
...
def test_get_title_and_highest_revenue(data_fixture: Any) -> None:
    """Test get_title_and_highest_or_lowest_revenue function."""
    assert (
...
def test_get_title_and_lowest_revenue_and_release_date(data_fixture: Any) -> None:
...
def test_get_title_and_highest_revenue_and_release_date(data_fixture: Any) -> None:
    """Test get_title_and_highest_or_lowest_revenue_and_release_data function."""
    assert (
